...
import { useGetPurchaseByIdMutation, usePostPurchaseMutation } from "../../features/PruchaseApi/PurchaseApi";
...
const EditPurchase = () => {
    ...
    const [getPurchaseById, {
            data: purchaseByIdData,
            error: purchaseByIdError,
            isLoading: purchaseByIdIsLoading,
        }] = useGetPurchaseByIdMutation({});

        console.log("from edit purchase", purchaseByIdData);
        
    
    const [initialValues, setInitialValues] = useState({
        vendorId: purchaseByIdData?.vendorId || null,
        GSTNo: purchaseByIdData?.gstNo || "",
        invoiceNo: purchaseByIdData?.invoiceNo ||"",
        invoiceDate: (purchaseByIdData?.invoiceDate) ||"",
        consignedTo: purchaseByIdData?.consignedTo ||null,
        purchaseOrderNo: purchaseByIdData?.orderNo ||"",
        purchaseOrderDate: purchaseByIdData?.orderDate ||"",
        modeOfDespatch: purchaseByIdData?.modeOfDispatch ||"",
        transporter:purchaseByIdData?.transporter || "",
        LR_RR_No: purchaseByIdData?.lrRrNo ||"",
        LR_RR_Date:purchaseByIdData?.lrRrDate || "",
        packingBox: purchaseByIdData?.packingBox ||"",
        weight: purchaseByIdData?.weight ||"",

        category: purchaseByIdData?.purchaseDetails?.categoryName || null,
        product: purchaseByIdData?.purchaseDetails?.productName || null,
        model: purchaseByIdData?.purchaseDetails?.modelName || null,
        hsnCode:  "",
        tax:purchaseByIdData?.purchaseDetails?.tax || "",
        quantity: purchaseByIdData?.purchaseDetails?.quantity || "",
        unitRate: purchaseByIdData?.purchaseDetails?.unitRate ||"",
        // masterTax: "",
        taxAmount:purchaseByIdData?.purchaseDetails?.taxAmount || "",
        MRPrate: purchaseByIdData?.purchaseDetails?.mrpRate ||"",
        amount:purchaseByIdData?.purchaseDetails?.amount || "",

        packing:purchaseByIdData?.packing || "",
        freight: purchaseByIdData?.freight ||"",
        taxTotal:purchaseByIdData?.taxAmountGst || "",
        paidDate: purchaseByIdData?.paidDate ||"",
        paidAmount:purchaseByIdData?.paidAmount || "",
    })
    ...
    useEffect(() => {
        if (purchaseByIdData) {
            const formattedDate = new Date(purchaseByIdData.invoiceDate);
            setInitialValues({
                vendorId: purchaseByIdData.vendorId || null,
                GSTNo: purchaseByIdData.gstNo || "",
                invoiceNo: purchaseByIdData.invoiceNo || "",
                ...
                // category: purchaseByIdData.purchaseDetails?.categoryName && {label:purchaseByIdData.purchaseDetails?.categoryName, value:purchaseByIdData.purchaseDetails?.categoryName} || null,
                category: purchaseByIdData.purchaseDetails?.categoryName
    ? { label: purchaseByIdData.purchaseDetails.categoryName, value: purchaseByIdData.purchaseDetails.categoryName }
    : null,
                product: purchaseByIdData.purchaseDetails?.productName || null,
                model: purchaseByIdData.purchaseDetails?.modelName || null,
                hsnCode: "",
                tax: purchaseByIdData.purchaseDetails[0]?.tax || "",
                quantity: purchaseByIdData.purchaseDetails[0]?.quantity || "",
                unitRate: purchaseByIdData.purchaseDetails[0]?.unitRate || "",
                taxAmount: purchaseByIdData.purchaseDetails[0]?.taxAmount || "",
                MRPrate: purchaseByIdData.purchaseDetails[0]?.mrpRate || "",
                amount: purchaseByIdData.purchaseDetails[0]?.amount || "",
