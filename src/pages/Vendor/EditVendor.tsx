...
import { usePostVendorMutation,useGetBankListQuery, useGetAccountTypesQuery, useGetVendorByIdQuery, useUpdateVendorMutation } from '../../features/VendorService/vendorApi';
