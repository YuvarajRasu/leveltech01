...
import { useGetAccountTypesQuery, useGetBankListQuery, useGetVendorByIdQuery, usePostVendorMutation, useUpdateVendorMutation } from '../../features/VendorService/vendorApi';
...
console.log("banck, account-types" , bankListdata, accountTypesData);
  ...
  const [postVendor, { data: postVendorData, isLoading: postVendorIsLoading, isError: postVendorIsError }] = usePostVendorMutation()
    const [updateVendor, { data: updateVendorData, isLoading: updateVendorIsLoading, isError: updateVendorIsError }] = useUpdateVendorMutation()
